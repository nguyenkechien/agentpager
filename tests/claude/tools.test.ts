...
import { createTelegramMcpServer, deliverFile, type FileSender } from '../../src/claude/tools.js';
...
describe('createTelegramMcpServer', () => {
  it('creates an in-process server named telegram', () => {
    const server = createTelegramMcpServer(sender, 7, cwd);
