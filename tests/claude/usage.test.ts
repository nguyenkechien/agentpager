...
describe('parseUsageResponse', () => {
  it('extracts the known plan windows in display order', () => {
    expect(parseUsageResponse(spikePayload)).toEqual({
      ...
      windows: [
        { key: 'five_hour', label: '5 giờ', utilizationPercent: 39, resetsAtMs: Date.parse('2026-09-14T07:40:00.478229+00:00') },
        { key: 'seven_day', label: '7 ngày', utilizationPercent: 46, resetsAtMs: Date.parse('2026-09-17T14:00:00.478247+00:00') },
        { key: 'seven_day_sonnet', label: '7 ngày · Sonnet', utilizationPercent: 12, resetsAtMs: null },
        { key: 'model:Fable', label: '7 ngày · Fable', utilizationPercent: 3, resetsAtMs: Date.parse('2026-09-17T14:00:00.478439+00:00') },
      ],
    });
  });
