...
import { buildUserMessage, eventsFromMessage, outcomeFromMessage } from '../../src/claude/runner.js';
...
describe('buildUserMessage', () => {
  ...
  it('puts the image block before the text block', () => {
    expect(buildUserMessage({ kind: 'photo', imageBase64: 'AAA', mediaType: 'image/jpeg', text: 'caption' })).toEqual({
      type: 'user',
      message: {
        role: 'user',
        content: [
